  ...
  return (
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950">
      ...
      <main className="max-w-3xl mx-auto px-4 py-12 prose prose-zinc dark:prose-invert">
        ...
        <h2>8. Data We Declare to the App Store</h2>
        <p>
          In compliance with Apple&apos;s App Store privacy requirements, we
          declare the following data types as linked to your identity and
          used for app functionality only (not for tracking or advertising):
        </p>
        <ul>
          <li>
            <strong>Contact Info:</strong> name, email (from Apple Sign-in or
            Strava).
          </li>
          <li>
            <strong>Location:</strong> coarse location (city/state) — used to
            find nearby training partners.
          </li>
          <li>
            <strong>Health &amp; Fitness:</strong> workouts and activity
            summaries from Strava (distance, pace, time, route start/end).
          </li>
          <li>
            <strong>User Content:</strong> messages you send, planned
            activities you create, profile fields you enter.
          </li>
          <li>
            <strong>Identifiers:</strong> user account ID, Strava athlete ID.
          </li>
        </ul>
        <p>
          We do <strong>not</strong> collect: browsing history, search
          history, contacts, financial info, precise device location, sensitive
          info, purchases, or any data used for tracking you across apps and
          websites owned by other companies.
        </p>

        <h2>9. Sign in with Apple</h2>
        <p>
          If you sign in with Apple and choose to hide your email, we receive
          a relay address generated by Apple. Emails we send will reach your
          real inbox via that relay. You can revoke corillo&apos;s access
          from your Apple ID settings at any time.
        </p>

        <h2>10. Minors</h2>
        <p>
          corillo is only for users 17 and older. We confirm your age during
          onboarding. If we learn we have collected data from someone under
          17, we will delete it promptly. Contact{" "}
          <a href="mailto:privacy@corillo.app">privacy@corillo.app</a> if you
          believe a minor has an account.
        </p>

        <h2>11. Moderation &amp; Safety Data</h2>
        <p>
          If you report another user, we retain the report and context
          (message IDs, run IDs, your reason text) for moderation review for
          as long as needed to enforce our terms. If the reported user
          deletes their account, their identity is detached from the report
          but the report itself is retained for pattern detection.
        </p>
